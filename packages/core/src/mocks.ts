...
import { webhookMocks, type WebhookMock, type NewWebhookMock } from "./db/schema.js";

export async function getMockData(webhookName: string): Promise<WebhookMock | null> {
